                ...
                <div class="max-w-7xl mx-auto">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="group p-8 rounded-3xl bg-blue-50/50 border border-blue-100 hover:bg-blue-100/50 hover:shadow-xl transition-all duration-300">
                            ...
                            <h3 class="text-2xl font-bold text-blue-900 mb-4">{"Oferta Académica"}</h3>
                            <ul class="space-y-2 text-blue-800/70 text-sm font-medium">
                                <li class="hover:text-blue-600 cursor-pointer transition-colors font-bold">{"• Informes generales"}</li>
                                <li class="hover:text-blue-600 cursor-pointer transition-colors font-bold">{"• Cursos de idiomas)"}</li>
                                <li class="hover:text-blue-600 cursor-pointer transition-colors font-bold">{"• Talleres (L-V y Sabatino)"}</li>
                                <li class="hover:text-blue-600 cursor-pointer transition-colors font-bold">{"• Exámenes de certificación"}</li>
                            </ul>
                        </div>
                        ...
                        <div class="group p-8 rounded-3xl bg-purple-50/50 border border-purple-100 hover:bg-purple-100/50 hover:shadow-xl transition-all duration-300">
                            ...
                            <h3 class="text-2xl font-bold text-purple-900 mb-4">{"Material Didáctico"}</h3>
                            <ul class="space-y-2 text-purple-800/70 text-sm font-medium">
                                <li class="hover:text-purple-600 cursor-pointer transition-colors font-bold">{"• Hojas de ejercicios"}</li>
                                <li class="hover:text-purple-600 cursor-pointer transition-colors font-bold">{"• Exámenes de práctica"}</li>
                            </ul>
                        </div>
                        ...
                        <div class="group p-8 rounded-3xl bg-amber-50/50 border border-amber-100 hover:bg-amber-100/50 hover:shadow-xl transition-all duration-300">
                            ...
                            <h3 class="text-2xl font-bold text-amber-900 mb-4">{"Departamentos"}</h3>
                            <ul class="space-y-2 text-amber-800/70 text-sm font-medium">
                                <li class="hover:text-amber-600 cursor-pointer transition-colors font-bold">{"• Registro"}</li>
                                <li class="hover:text-amber-600 cursor-pointer transition-colors font-bold">{"• Inglés"}</li>
                                <li class="hover:text-amber-600 cursor-pointer transition-colors font-bold">{"• Italiano"}</li>
                                <li class="hover:text-amber-600 cursor-pointer transition-colors font-bold">{"• Japonés"}</li>
                            </ul>
                        </div>
                        ...
                        <div class="group p-8 rounded-3xl bg-emerald-50/50 border border-emerald-100 hover:bg-emerald-100/50 hover:shadow-xl transition-all duration-300">
                            ...
                            <ul class="space-y-2 text-emerald-800/70 text-sm font-medium">
                                <li class="hover:text-emerald-600 cursor-pointer transition-colors font-bold">{"• ¿Quiénes somos?"}</li>
                                <li class="hover:text-emerald-600 cursor-pointer transition-colors font-bold">{"• Difusión cultural"}</li>
                                <li class="hover:text-emerald-600 cursor-pointer transition-colors font-bold">{"• SELITA"}</li>
                                <li class="hover:text-emerald-600 cursor-pointer transition-colors font-bold">{"• Podcast"}</li>
                                <li class="hover:text-emerald-600 cursor-pointer transition-colors font-bold">{"• Contáctanos"}</li>
                                <li class="hover:text-emerald-600 cursor-pointer transition-colors font-bold">{"• Historia"}</li>
                            </ul>
                        </div>
                    </div>
                </div>
